          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0">Employee Management Software</h1>
              </div>
              <div className="col-sm-6">
                    ...
                    <div className="direct-chat-messages">
                      <div className="direct-chat-msg">
                        <div className="direct-chat-infos clearfix">
                          <span className="direct-chat-name float-left">Rahul Shrestha</span>
                          <span className="direct-chat-timestamp float-right">23 Sep 2:00 pm</span>
                        </div>

                        <div className="direct-chat-text">
                          Is there any vacancy for frontend Developer?
                        </div>
                      </div>
                      <div className="direct-chat-msg right">
                        <div className="direct-chat-infos clearfix">
                          <span className="direct-chat-name float-right">Alina Sharma</span>
                          <span className="direct-chat-timestamp float-left">23 Sep 2:05 pm</span>
                        </div>

                        <div className="direct-chat-text">
                          Yeah, but experience of more than 1 year
                        </div>
                      </div>
                      <div className="direct-chat-msg">
                        <div className="direct-chat-infos clearfix">
                          <span className="direct-chat-name float-left">Rahul Shrestha</span>
                          <span className="direct-chat-timestamp float-right">23 Sep 5:37 pm</span>
                        </div>

                        <div className="direct-chat-text">
                          yes,want to work with NoveltyTechnology on a great new app! Wanna join?
                        </div>
                      </div>
                      <div className="direct-chat-msg right">
                        <div className="direct-chat-infos clearfix">
                          <span className="direct-chat-name float-right">Alina Sharma</span>
                          <span className="direct-chat-timestamp float-left">23 Sep 6:10 pm</span>
                        </div>
                ...
                <div className="card bg-gradient-primary">
                  ...
                  <div className="card-footer bg-transparent">
                    <div className="row">
                      ...
                      <div className="col-4 text-center">
                        <div id="sparkline-3" />
                        <div className="text-white">Employee</div>
                      </div>
                    </div>
                  </div>
                </div>
